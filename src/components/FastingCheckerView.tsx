...
export const FastingCheckerView: React.FC<FastingCheckerViewProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'berbuka' | 'makan_siang'>('berbuka');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-2 rounded-2xl border border-gray-200/90 shadow-sm flex flex-wrap gap-2">
        <button
          type="button"
      ...
      {/* ======================================================== */}
      {/* TAB 1: CEKLIST BERBUKA (DATA SISWA BERPUASA)             */}
      {/* ======================================================== */}
      {activeTab === 'berbuka' && (
      ...
      {/* ======================================================== */}
      {/* TAB 2: CEKLIST MAKAN SIANG (DATA SISWA TIDAK PUASA)      */}
      {/* ======================================================== */}
      {activeTab === 'makan_siang' && (
        <div className="space-y-4">
